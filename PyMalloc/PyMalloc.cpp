...
class D1 : public Base, virtual public C
{
public:
	D1(): b(9999) {}
public:
...
int main()
{
	...
	void * ptr = PyObject_Malloc(100);
	cout << ptr << endl;

	ptr = PyObject_Malloc(100);
	cout << ptr << endl;

	ptr = PyObject_Malloc(10);
	cout << ptr << endl;
